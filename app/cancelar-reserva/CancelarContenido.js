...
export default function CancelarContenido() {
  ...
  const contenido = {
    cargando: { emoji: "⏳", titulo: "Procesando...", mensaje: "Estamos cancelando tu reserva.", color: "#534AB7" },
    cancelado: { emoji: "✅", titulo: "Reserva cancelada", mensaje: "Tu reserva fue cancelada exitosamente. ¡Esperamos verte pronto!", color: "#16a34a" },
    error: { emoji: "⚠️", titulo: "Link inválido", mensaje: "Esta reserva ya fue cancelada o el link no es válido.", color: "#dc2626" },
  }
